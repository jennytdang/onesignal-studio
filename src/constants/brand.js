export const COLORS = {
  purple600: '#4E50D1', purple500: '#7274DA', purple400: '#9799E4',
  purple100: '#E5E6F8', purple50: '#F3F3FC', black: '#051B2C', white: '#FFFFFF',
  gray50: '#F3F4F5', gray100: '#E5E7E9', gray400: '#98A1A9', gray600: '#59626B', gray700: '#40464C',
  blue400: '#4DA6EF', cyan300: '#31E1DE', yellow300: '#FFC072',
}
...
export const BACKGROUNDS = {
  ...
  gradients: [
    { id: 'grad-1', label: 'Purple Haze', isDark: true,  useImage: true, src: '/onesignal-gradient-1.png', style: { backgroundImage: 'url(/onesignal-gradient-1.png)', backgroundSize: 'cover', backgroundPosition: 'center' } },
    { id: 'grad-2', label: 'Ocean',       isDark: true,  useImage: true, src: '/onesignal-gradient-2.png', style: { backgroundImage: 'url(/onesignal-gradient-2.png)', backgroundSize: 'cover', backgroundPosition: 'center' } },
    { id: 'grad-3', label: 'Cyan Wave',   isDark: true,  useImage: true, src: '/onesignal-gradient-3.png', style: { backgroundImage: 'url(/onesignal-gradient-3.png)', backgroundSize: 'cover', backgroundPosition: 'center' } },
    { id: 'grad-4', label: 'Mint',        isDark: false, useImage: true, src: '/onesignal-gradient-4.png', style: { backgroundImage: 'url(/onesignal-gradient-4.png)', backgroundSize: 'cover', backgroundPosition: 'center' } },
  ],
}
