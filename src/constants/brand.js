...
export const BACKGROUNDS = {
  ...
  gradients: [
    { id: 'grad-purple', label: 'Purple Haze', isDark: true,  useImage: false, style: { background: 'radial-gradient(ellipse 140% 100% at 10% 90%, #2F31B1 0%, #4E50D1 35%, #7274DA 60%, #5B89E8 100%)' } },
    { id: 'grad-ocean',  label: 'Ocean',       isDark: true,  useImage: false, style: { background: 'radial-gradient(ellipse 120% 120% at 90% 10%, #4DA6EF 0%, #5562D9 45%, #7274DA 100%)' } },
    { id: 'grad-cyan',   label: 'Cyan Wave',   isDark: true,  useImage: false, style: { background: 'radial-gradient(ellipse 120% 120% at 90% 90%, #31E1DE 0%, #4DA6EF 45%, #7274DA 100%)' } },
    { id: 'grad-mint',   label: 'Mint',        isDark: false, useImage: false, style: { background: 'radial-gradient(ellipse 120% 100% at 80% 10%, #FFFFFF 0%, #AFF4F2 30%, #4DA6EF 65%, #7274DA 100%)' } },
  ],
}
