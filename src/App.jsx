        ...
        <div className="sidebar-scroll" style={{flex:1,overflowY:'auto',padding:'14px 14px 24px'}}>
          ...
          {template !== 'quote' && template !== 'event' && template !== 'newhire' && (<>
            ...
            <div style={{display:'flex',gap:6,marginBottom:14}}>
              {['left','center'].map(a=><button key={a} onClick={()=>setLogoAlign(a)} style={{flex:1,padding:'7px 0',fontSize:12,fontFamily:"'Epilogue',sans-serif",background:logoAlign===a?T.purple50:'transparent',color:logoAlign===a?T.purple:T.textMuted,fontWeight:logoAlign===a?500:400,border:`1px solid ${logoAlign===a?T.purple:T.border}`,borderRadius:2,cursor:'pointer',textTransform:'capitalize',fontWeight:logoAlign===a?600:400}}>{a}</button>)}
            </div>
          </>)}
          <Divider/>
