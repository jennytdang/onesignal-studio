...
const TEMPLATE_DEFAULTS = {
  ...
  stat:     { pill:'', headline:'', subheadline:'OneSignal now empowers over a million businesses to send 12 billion messages daily.', cta:'Get started now', stat:'', statLabel:'Apps powered by OneSignal', authorName:'', authorTitle:'', authorCompany:'', showHeadshot:false, headshotUrl:'', eventDate:'', eventLocation:'', speakers:[{name:'',title:'',company:'',photo:''}], emoji:'🎉', quoteBlock:false },
