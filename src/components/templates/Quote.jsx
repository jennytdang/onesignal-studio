...
export default function Quote({ fields, dimension, isDark, logoAlign = 'left', backgroundId }) {
  ...
  const authorNameSz = id==='story'?48:id==='square'?38:id==='landscape'?44:Math.round(S.authorName(width, height))
  const authorTitleSz= id==='story'?40:id==='square'?32:id==='portrait'?30:id==='landscape'?38:Math.round(S.authorTitle(width, height))
